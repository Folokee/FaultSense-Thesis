...
\begin{figure}[H]
  ...
  \caption{Row-level versus episode-level class distribution in Costa. Shadowing episodes are numerous but short; induced fault episodes are few but long.}
...
\begin{figure}[H]
  ...
  \caption{Normal versus fault distributions for the top 5 binary-MI channels (Costa). Fault classes show shifted medians and wider spread relative to normal operation.}
...
\begin{figure}[H]
  ...
  \caption{Mutual information of Costa channels against binary (left) and multi-class (right) fault labels. Multi-class MI is consistently higher across all channels, motivating the use of the multi-class label for feature selection.}
  \label{fig:eda-mi}
\end{figure}
