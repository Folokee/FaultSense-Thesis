...
\usepackage[english]{babel}   % switch to [french] if needed
\usepackage{csquotes}

% ── Page geometry ───────────────────────────────────────────
\usepackage[a4paper, top=2.5cm, left=2.5cm, right=2.5cm, bottom=3.5cm, footskip=1cm]{geometry}
...
\usepackage{pdfpages}             % Include external PDF pages (Arabic abstract)
